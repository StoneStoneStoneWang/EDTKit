//
//  DCTAddressSelectedViewController.m
//  ZFragment
//
...
#import "DCTAddressSelectedViewController.h"

@import Masonry;
@import SToolsKit;
@import JXTAlertManager;

@interface DCTAddressSelectedTableViewCell : DCTBaseTableViewCell
...
@end
@implementation DCTAddressSelectedTableViewCell
...
@interface DCTAddressSelectedViewController ()

@property (nonatomic ,strong) DCTAddressBridge *bridge;

@property (nonatomic ,strong) UIButton *completeItem;

@property (nonatomic ,copy) DCTAddressSelectedBlock addressBlock;

@end

@implementation DCTAddressSelectedViewController

+ (instancetype)createAddressSelectedWithBlock:(DCTAddressSelectedBlock) addressBlock {
    
    return [[DCTAddressSelectedViewController alloc] initWithBlock:addressBlock];
}
- (instancetype)initWithBlock:(DCTAddressSelectedBlock) addressBlock {
...
- (void)configOwnSubViews {
    ...
    [self.tableView registerClass:[DCTAddressSelectedTableViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)configTableViewCell:(id)data forIndexPath:(NSIndexPath *)ip {
    ...
    DCTAddressSelectedTableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"cell"];
    
    if (!cell) {
        
        cell = [[DCTAddressSelectedTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
