//
//  EDTAddressSelectedViewController.m
//  ZFragment
//
...
#import "EDTAddressSelectedViewController.h"

@import Masonry;
@import SToolsKit;
@import JXTAlertManager;

@interface EDTAddressSelectedTableViewCell : EDTBaseTableViewCell
...
@end
@implementation EDTAddressSelectedTableViewCell
...
@interface EDTAddressSelectedViewController ()

@property (nonatomic ,strong) EDTAddressBridge *bridge;

@property (nonatomic ,strong) UIButton *completeItem;

@property (nonatomic ,copy) EDTAddressSelectedBlock addressBlock;

@end

@implementation EDTAddressSelectedViewController

+ (instancetype)createAddressSelectedWithBlock:(EDTAddressSelectedBlock) addressBlock {
    
    return [[EDTAddressSelectedViewController alloc] initWithBlock:addressBlock];
}
- (instancetype)initWithBlock:(EDTAddressSelectedBlock) addressBlock {
...
- (void)configOwnSubViews {
    ...
    [self.tableView registerClass:[EDTAddressSelectedTableViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)configTableViewCell:(id)data forIndexPath:(NSIndexPath *)ip {
    ...
    EDTAddressSelectedTableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"cell"];
    
    if (!cell) {
        
        cell = [[EDTAddressSelectedTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
