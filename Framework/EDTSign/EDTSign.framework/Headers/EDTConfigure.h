...
typedef NS_ENUM(NSInteger ,EDTConfigureType) {
    /** 游泳  */
    EDTConfigureTypeSwimming NS_SWIFT_NAME(swimming) = 0,
};

NS_ASSUME_NONNULL_BEGIN

@interface EDTConfigure : NSObject
